...
urlpatterns = [
    ...
    path('invitation_success/', views.invitation_success, name='invitation_success'),
    ...
    path('donation/confirm/<int:donation_id>/', views.confirm_donation, name='confirm_donation'),
